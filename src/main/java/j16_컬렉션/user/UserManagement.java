...
public class UserManagement {
	...
	public static void main(String[] args) {
		...
		UserRepository userRepository = new UserRepository(userList); //depedency injection
		...
		userRepository.modifyPasswordByUsernaem("b1", "1234");
		System.out.println(userRepository.findUserByUsername("b1"));
		
		userRepository.deleteUserByUsername("b1");
		userRepository.deleteUserByUsername("f1");
		System.out.println(userRepository.getUserList());
	}
}
